...
final kTempRecipeMpodel = RecipeModel(
    ...
    steps: [
      "In a large pot, heat the olive oil over medium heat. Add the onion, carrots, and celery and cook until vegetables are tender, about 5 minutes. Add the garlic and cook for an additional 2 minutes.",
      "Add the vegetable broth, white beans, diced tomatoes, pasta, and rosemary. Stir and bring to a boil. Reduce heat and simmer for 15 minutes.",
      "Stir in the parsley and season with salt and black pepper, to taste. Ladle soup into bowls and serve with grated Parmesan cheese, if desired."
    ],
    duration: 30,
    imageUrl:
